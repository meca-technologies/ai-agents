...
class AIChatController extends Controller
{
  ...
  public function openAIChatList()
  {
    ...
    $aiList = OpenaiGeneratorChatCategory::where(function ($query) use ($user) {
      $query->global()
  ...
  public function openAIChatUpdate($id = null)
  {
    if ($id == null) {
      $template = null;
    } else {
    ...
    return view('panel.user.openai_chat.form_aichat_update', compact('template'));
  }
