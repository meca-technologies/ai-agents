        ...
        <div class="container-xl">
            <div class="row">
                <div class="col-md-5 mx-auto">
                    <form id="custom_template_form"
                        onsubmit="return templateAIChatSave({{ $template != null ? $template->id : null }});" action=""
                        ...
                        <div class="mb-[20px]">
                            ...
                            <input type="text" class="form-control" id="name_user_aichat" name="name"
                        ...
                        <div class="mb-[20px]">
                            <label class="form-label">
                                ...
                                <x-info-tooltip
                                    text="{{ __('Shortened name of the template or human name. Maximum 3 letters is suggested.') }}" />
                            </label>
                            <input type="text" class="form-control" id="short_name_user_aichat" name="short_name"
                        ...
                        <div class="mb-[20px]">
                            ...
                            <textarea class="form-control" id="description_user_aichat" name="description">{{ $template != null ? $template->description : null }}</textarea>
                        </div>
                        <div class="mb-[20px]">
                            <label class="form-label">
                                {{ __('Avatar') }}
                            ...
                            <input type="file" class="form-control" id="avatar_user_aichat" name="avatar"
                                value="{{ $template != null ? $template->short_name : null }}">
                        </div>
                        <div class="mb-20">
                            <label class="form-label">
                            ...
                            <div class="form-control flex items-center gap-2 relative">
                                <div class="w-[17px] h-[17px] rounded-full overflow-hidden">
                                    <input type="color"
                                        ...
                                        id="color_user_aichat" name="color"
                                        value="{{ $template != null ? $template->color : '#8fd2d0' }}">
                                </div>
                                <input class="bg-transparent border-none outline-none text-inherit"
                                    id="color_value_user_aichat" name="color_value"
                                    value="{{ $template != null ? $template->color : '#8fd2d0' }}" />
                            </div>
                        </div>
                        ...
                        <div class="mb-[20px]">
                            <label class="form-label">
                                {{ __('Human Name') }}
                                <x-info-tooltip
                                    text="{{ __('Define a human name for the chatbot to give it more personality.') }}" />
                            </label>
                            <input type="text" class="form-control" id="human_name_user_aichat"
                                placeholder="Allison Burgers" name="human_name"
                        ...
                        <div class="mb-[20px]">
                            <label class="form-label">
                                {{ __('Template Role') }}
                                <x-info-tooltip
                                    text="{{ __('A role for the chatbot that can define what it can help with. For example Finance Expert.') }}" />
                            </label>
                            <input type="text" class="form-control" id="role_user_aichat" name="role"
                                placeholder="Finance Expert" value="{{ $template != null ? $template->role : null }}">
                        </div>
                        <div class="mb-[20px]">
                            <label class="form-label">
                                {{ __('Helps With') }}
                                <x-info-tooltip
                                    text="{{ __('Describe what this chatbot can help with. It shows when starting a conversation and the chatbot introducing itself.') }}" />
                            </label>
                            <textarea class="form-control" id="helps_with_user_aichat" placeholder="I can help you with managing your finance"
                                name="helps_with">{{ $template != null ? $template->helps_with : null }}</textarea>
                        </div>
                        <div class="mb-[20px]">
                            <label class="form-label">
                                {{ __('Chatbot Training') }}
                                ...
                                <button type="button"
                                    class="chat-completions-fill-btn bg-primary !bg-opacity-5 border-none !px-3 !py-1 rounded-full transition-transform cursor-pointer text-sm font-medium text-white">{{ __('Create example input') }}</button>
                            </label>
                            <textarea class="form-control" id="chat_completions_temp_user_aichat" name="chat_completions">{{ $template != null ? $template->chat_completions : null }}</textarea>
                            <div class="!mt-3">
                                <a class="text-heading"
                                    href="https://platform.openai.com/docs/guides/gpt/chat-completions-api"
                                    target="_blank">{{ __('More Info') }}<svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        <button form="custom_template_form" id="custom_template_button_user_aichat"
...
@section('script')
    ...
    <script>
        var editor_chat_completions = ace.edit("chat_completions_temp_user_aichat");
