            ...
            <div class="row">
                <div class="col-md-5 mx-auto">
                    <form id="custom_template_form"
                        onsubmit="return templateCustomChatSave({{ $template != null ? $template->id : null }});"
                        ...
                        <div class="mb-[20px]">
                            ...
                            <input type="text" class="form-control" id="short_name_user" name="short_name"
                        ...
                        <div class="mb-[20px]">
                            ...
                            <textarea class="form-control" id="description_user" name="description">{{ $template != null ? $template->description : null }}</textarea>
                        </div>
                        <div class="mb-[20px]">
                            <label class="form-label">
                                {{ __('Avatar') }}
                            ...
                            <input type="file" class="form-control" id="avatar_user" name="avatar"
                                value="{{ $template != null ? $template->short_name : null }}">
                        </div>
                        <div class="mb-20">
                            <label class="form-label">
                            ...
                            <div class="form-control flex items-center gap-2 relative">
                                <div class="w-[17px] h-[17px] rounded-full overflow-hidden">
                                    <input type="color"
                                        ...
                                        id="color_user" name="color"
                                        value="{{ $template != null ? $template->color : '#8fd2d0' }}">
                                </div>
                                <input class="bg-transparent border-none outline-none text-inherit" id="color_value_user"
                                    name="color_value" value="{{ $template != null ? $template->color : '#8fd2d0' }}" />
                            </div>
                        </div>
                        ...
                        <div class="mb-[20px]">
                            ...
                            <input type="text" class="form-control" id="human_name_user" placeholder="Allison Burgers"
                                name="human_name" value="{{ $template != null ? $template->human_name : null }}">
                        </div>
                        <div class="mb-[20px]">
                            <label class="form-label">
                                {{ __('Template Role') }}
                            ...
                            <input type="text" class="form-control" id="role_user" name="role"
                        ...
                        <div class="mb-[20px]">
                            ...
                            <textarea class="form-control" id="helps_with_user" placeholder="I can help you with managing your finance"
                        ...
                        <div class="mb-[20px]">
                            ...
                            <textarea class="form-control" id="chat_completions_temp_user" name="chat_completions">{{ $template != null ? $template->chat_completions : null }}</textarea>
                            <div class="!mt-3">
                        ...
                        <button form="custom_template_form" id="custom_template_button_user"
...
@section('script')
    ...
    <script>
        var editor_chat_completions = ace.edit("chat_completions_temp_user");
