        ...
        <div class="p-0 container-fluid max-lg:w-full">
            ...
            <div class="collapse navbar-collapse" id="navbar-menu">
                <ul class="primary-nav navbar-nav max-lg:py-4 max-lg:px-3">
                    ...
                    @endif
                    <li class="nav-item">
                        <a class="nav-link {{ route('dashboard.user.appointment') == url()->current() ? 'active' : '' }}"
                            href="{{ route('dashboard.user.appointment') }}">
                            <span class="nav-link-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" stroke-width="1.5" fill="none" stroke-linecap="round"
                                    stroke-linejoin="round">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ route('dashboard.user.openai.chat.custom-list') == url()->current() ? 'active' : '' }}"
                            href="{{ route('dashboard.user.openai.chat.custom-list') }}">
                            <span class="nav-link-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" stroke-width="1.5" fill="none" stroke-linecap="round"
                                    stroke-linejoin="round">
                    ...
                    @if (Auth::user()->type == 'admin')
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div
                                ...
                                <a class="dropdown-item {{ activeRoute('dashboard.email-templates.list') }}"
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div
                                class="dropdown-menu {{ activeRouteBulkShow(['dashboard.admin.settings.general', 'dashboard.admin.settings.invoice', 'dashboard.admin.settings.payment', 'dashboard.admin.settings.openai', 'dashboard.admin.settings.affiliate', 'dashboard.admin.settings.smtp', 'amamarul.translations.home', 'amamarul.translations.lang', 'dashboard.admin.settings.gdpr', 'dashboard.admin.settings.privacy', 'dashboard.admin.settings.tts', 'dashboard.admin.settings.storage']) }}">
                            ...
                            <li class="nav-item">
                                ...
                                <div class="row">
                                    <div class="col-auto d-flex align-items-center">
                                        ...
                                        <span
                                            class="d-none d-md-inline d-lg-none d-xxl-inline ms-2 text-muted">{{ number_format((int) Auth::user()->remaining_words) }}</span>
                                    </div>
                                    <div class="col-auto d-flex align-items-center">
                                        <span class="legend !me-2 rounded-full bg-[#9E9EFF]"></span>
                                        <span>{{ __('Image Credits') }}</span>
                                        <span
                                            class="d-none d-md-inline d-lg-none d-xxl-inline ms-2 text-muted">{{ number_format((int) Auth::user()->remaining_images) }}</span>
                                    </div>
                                </div>
                            </li>
                        </div>
...
<nav
    ...
    <ul class="grid grid-cols-4 place-items-center w-full p-0 m-0 list-none">
        ...
        <li class="w-full">
            <button
                class="flex flex-col items-center w-full h-auto p-0 collapsed bg-transparent text-inherit border-none group"
        ...
        <li class="w-full">
            <button
                class="flex flex-col items-center w-full h-auto p-0 collapsed bg-none bg-transparent rounded-full text-inherit border-none group outline-none translate-x-0 transform-gpu"
...
<div class="fixed bottom-20 end-12 z-50 hidden group lg:block">
    <button
        ...
        type="button">
        <span
            class="inline-flex items-center justify-center w-full h-full mb-1 relative rounded-full overflow-hidden before:w-full before:h-full before:absolute before:top-0 before:left-0 before:rounded-full before:bg-gradient-to-r before:from-[#8d65e9] before:via-[#5391e4] before:to-[#6bcd94] before:animate-spin-grow">
