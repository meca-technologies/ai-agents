...
-- Üretim Zamanı: 07 Ağu 2023, 11:05:48
-- Sunucu sürümü: 10.5.21-MariaDB
-- PHP Sürümü: 8.2.8
...
--
-- Tablo için tablo yapısı `advertis`
--
...
--
-- Tablo için tablo yapısı `bad_words`
--
...
CREATE TABLE `clients` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `avatar` varchar(255) NOT NULL DEFAULT 'assets/img/auth/default-avatar.png',
...
--
-- Tablo için tablo yapısı `customsettings`
--
...
--
-- Tablo döküm verisi `customsettings`
--
...
--
-- Tablo için tablo yapısı `frontend_footer_settings`
--

CREATE TABLE `frontend_footer_settings` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `header_title` varchar(255) NOT NULL DEFAULT 'Limited Offer',
  `header_text` varchar(255) NOT NULL DEFAULT 'Sign up and receive 20% bonus discount on checkout.',
  `hero_subtitle` varchar(255) NOT NULL DEFAULT 'Unleash the Power of AI',
  `hero_title` varchar(255) NOT NULL DEFAULT 'Ultimate AI',
  `hero_description` varchar(255) NOT NULL DEFAULT 'All-in-one platform to generate AI content and start making money in minutes.',
  `hero_scroll_text` varchar(255) NOT NULL DEFAULT 'Discover MagicAI',
  `hero_button` varchar(255) NOT NULL DEFAULT 'Start Making Money',
  `hero_button_url` varchar(255) DEFAULT NULL,
  `footer_header` varchar(255) NOT NULL DEFAULT 'Start your free trial.',
  `footer_text_small` varchar(255) NOT NULL DEFAULT 'Pay once, own forever.',
  `footer_text` varchar(255) NOT NULL DEFAULT 'Unlock your business potential by letting the AI work and generate money for you.',
  `footer_button_text` varchar(255) NOT NULL DEFAULT 'Join our community',
  `footer_button_url` varchar(255) NOT NULL DEFAULT 'https://codecanyon.net/item/magicai-openai-content-text-image-chat-code-generator-as-saas/45408109',
  `footer_copyright` varchar(255) NOT NULL DEFAULT '2023 MagicAI. All images are for demo purposes.',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `hero_title_text_rotator` varchar(255) DEFAULT 'Generator,Chatbot,Assistant',
  `sign_in` varchar(255) NOT NULL DEFAULT 'Sign In',
  `join_hub` varchar(255) NOT NULL DEFAULT 'Join Hub'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Tablo döküm verisi `frontend_footer_settings`
--

INSERT INTO `frontend_footer_settings` (`id`, `header_title`, `header_text`, `hero_subtitle`, `hero_title`, `hero_description`, `hero_scroll_text`, `hero_button`, `hero_button_url`, `footer_header`, `footer_text_small`, `footer_text`, `footer_button_text`, `footer_button_url`, `footer_copyright`, `created_at`, `updated_at`, `hero_title_text_rotator`, `sign_in`, `join_hub`) VALUES
(1, 'Limited Offer', 'Sign up and receive 20% bonus discount on checkout.', 'Unleash the Power of AI', 'Ultimate AI', 'All-in-one platform to generate AI content and start making money in minutes.', 'Discover MagicAI', 'Start Making Money', NULL, 'Start your free trial.', 'Pay once, own forever.', 'Unlock your business potential by letting the AI work and generate money for you.', 'Join our community', 'https://codecanyon.net/item/magicai-openai-content-text-image-chat-code-generator-as-saas/45408109', '2023 MagicAI. All images are for demo purposes.', '2023-08-07 11:05:10', '2023-08-07 11:05:10', 'Generator,Chatbot,Assistant', 'Sign In', 'Join Hub');

-- --------------------------------------------------------

--
-- Tablo için tablo yapısı `frontend_future`
--
...
--
-- Tablo döküm verisi `frontend_future`
--
...
--
-- Tablo için tablo yapısı `frontend_generators`
--
...
--
-- Tablo döküm verisi `frontend_generators`
--
...
(3, 'AI Image Generator', 'Unleash your creativity', 'AI', 'Create eye-catching images and graphics.', 'Generate high qualtity images for a wide range of applications', 'assets/img/site/image-generator.jpg', 'Imagine, Genearate, Publish.', 'Powered by Dall-E.', '#DFE5EB', '2023-06-02 15:33:09', '2023-06-02 15:33:09'),
...
(5, 'AI Chat Bot', 'Intuitive / Humanlike Chatbot ', 'AI', 'Meet your next virtual assistant.', 'Get instant answers to your questions, no matter the topic. Whether you’re looking to book a reservation, get product recommendations, or just chat about the weather, MagicAI is always ready and willing to help.', 'assets/img/site/ai-chat.jpg', 'Chat, Solve, Repeat.', 'Powered by OpenAI.', '#F9DDDF', '2023-06-02 15:33:09', '2023-06-02 15:33:09'),
...
--
-- Tablo için tablo yapısı `frontend_sections_statuses_titles`
--

CREATE TABLE `frontend_sections_statuses_titles` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `features_active` tinyint(1) NOT NULL DEFAULT 1,
  `features_title` varchar(255) NOT NULL DEFAULT 'The future of AI.',
  ...
  `custom_templates_subtitle_one` varchar(255) NOT NULL DEFAULT 'Custom',
  `custom_templates_subtitle_two` varchar(255) NOT NULL DEFAULT 'Prompts',
  `custom_templates_title` varchar(255) NOT NULL DEFAULT 'Custom Templates.',
  `custom_templates_description` text DEFAULT NULL,
  `tools_active` tinyint(1) NOT NULL DEFAULT 1,
  `tools_title` varchar(255) NOT NULL DEFAULT 'Magic Tools.',
  `tools_description` text DEFAULT NULL,
  `how_it_works_active` tinyint(1) NOT NULL DEFAULT 1,
  `how_it_works_title` varchar(255) NOT NULL DEFAULT 'So, how does it work?',
  `testimonials_active` tinyint(1) NOT NULL DEFAULT 1,
  `testimonials_title` varchar(255) NOT NULL DEFAULT 'Trusted by millions.',
  `testimonials_subtitle_one` varchar(255) NOT NULL DEFAULT 'Testimonials',
  `testimonials_subtitle_two` varchar(255) NOT NULL DEFAULT 'Trustpilot',
  `pricing_active` tinyint(1) NOT NULL DEFAULT 1,
  `pricing_title` varchar(255) NOT NULL DEFAULT 'Flexible Pricing.',
  `pricing_description` text DEFAULT NULL,
  `pricing_save_percent` varchar(255) NOT NULL DEFAULT 'Save 30%',
  `faq_active` tinyint(1) NOT NULL DEFAULT 1,
  `faq_title` varchar(255) NOT NULL DEFAULT 'Have a question?',
  `faq_subtitle` varchar(255) NOT NULL DEFAULT 'Our support team will get assistance from AI-powered suggestions, making it quicker than ever to handle support requests.',
  `faq_text_one` varchar(255) NOT NULL DEFAULT 'FAQ',
  `faq_text_two` varchar(255) NOT NULL DEFAULT 'Help Center',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `preheader_active` tinyint(1) NOT NULL DEFAULT 1,
  `blog_active` tinyint(1) NOT NULL DEFAULT 0,
  `blog_title` varchar(255) NOT NULL DEFAULT 'Latest News',
  `blog_subtitle` varchar(255) NOT NULL DEFAULT 'Stay up-to-date',
  `blog_posts_per_page` int(11) NOT NULL DEFAULT 3,
  `blog_button_text` varchar(255) NOT NULL DEFAULT 'Show more',
  `blog_a_title` varchar(255) NOT NULL DEFAULT 'Blog Posts',
  `blog_a_subtitle` varchar(255) NOT NULL DEFAULT 'Latest News',
  `blog_a_description` varchar(255) NOT NULL DEFAULT 'Welcome to our cozy corner of the internet, where you will find a delightful collection of our heartfelt and thought-provoking blog posts.',
  `blog_a_posts_per_page` int(11) NOT NULL DEFAULT 6
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Tablo döküm verisi `frontend_sections_statuses_titles`
--
...
--
-- Tablo için tablo yapısı `frontend_tools`
--
...
--
-- Tablo döküm verisi `frontend_tools`
--
...
--
-- Tablo için tablo yapısı `frontend_who_is_for`
--
...
--
-- Tablo döküm verisi `frontend_who_is_for`
--
...
--
-- Tablo için tablo yapısı `gatewayproducts`
--
...
--
-- Tablo için tablo yapısı `health_check_result_history_items`
--
...
--
-- Tablo için tablo yapısı `howitworks`
--
...
(86, '2023_07_13_133729_add_stream_server_option_to_settings_two_table', 1),
(87, '2023_07_13_143413_add_blog_options_to_frontend_sections_statuses_titles', 1),
(88, '2023_07_18_222043_add_image_storage_field_to_settings_two_table', 1),
(89, '2023_07_19_105519_add_package_column_to_openai_table', 1),
(90, '2023_07_21_121324_options_to_settingstwo_table', 1),
(91, '2023_07_24_103747_create_subscriptions_yokassa_table', 1);

-- --------------------------------------------------------

--
-- Tablo için tablo yapısı `oldgatewayproducts`
--
...
CREATE TABLE `oldgatewayproducts` (
  ...
  `gateway_code` varchar(255) DEFAULT NULL,
  `product_id` varchar(255) DEFAULT NULL,
  `old_price_id` varchar(255) DEFAULT NULL,
  `new_price_id` varchar(255) DEFAULT NULL,
...
--
-- Tablo için tablo yapısı `openai`
--
...
CREATE TABLE `openai_chat_category` (
  ...
  `helps_with` varchar(255) DEFAULT NULL,
  `prompt_prefix` varchar(255) DEFAULT NULL,
  `image` varchar(255) DEFAULT NULL,
  `color` varchar(255) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
--
-- Tablo döküm verisi `openai_chat_category`
--
...
(1, 'Default AI Chat Bot', 'ACB', 'ai-chat-bot', 'Default', 'default', '', '', '', '', '#A3D6C2', '2023-05-16 03:34:57', '2023-05-16 03:39:11', NULL),
(2, 'Finance Expert', 'FE', 'finance-expert', 'Personal Finance Expert', 'Finance Expert', 'Allison Burgers', 'I can help you with managing your finance', 'As a personal finance expert,', NULL, '#DBD5F5', '2023-05-16 03:34:57', '2023-05-16 03:39:11', NULL),
(3, 'Nutritionist', 'N', 'nutritionist', 'Personal Nutritionist', 'Nutritionist', 'Employes Mustwashhands', 'I can assist you with nutrition-related information or questions', 'As a nutritionist,', NULL, '#EDBBBE', '2023-05-16 03:34:57', '2023-05-16 03:39:11', NULL),
(4, 'Career Counselor', 'CC', 'career-counselor', 'Personal Career Counselor', 'Career Counselor', 'Neil Feetstrong', 'I can assist you with your career-related inquiries or concerns', 'As a career counselor,', NULL, '#D4D4E2', '2023-05-16 03:34:57', '2023-05-16 03:39:11', NULL),
(5, 'Time Management Consultant', 'TMC', 'time-management-consultant', 'Personal Time Management Consultant', 'Time Management Consultant', 'Sarman Yellow', 'I can assist you with improving your time management skills or addressing any time management challenges you may be facing', 'As a time management consultant,', NULL, '#D6CBA3', '2023-05-16 03:34:57', '2023-05-16 03:39:11', NULL),
(6, 'Language Tutor', 'LT', 'language-tutor', 'Personal Language Tutor', 'Language Tutor', 'Sherlock Jonas', 'I can assist you with your language learning goals or provide guidance on language-related topics', 'As a language tutor,', NULL, '#EACCEB', '2023-05-16 03:34:57', '2023-05-16 03:39:11', NULL),
(7, 'Cybersecurity Expert', 'CE', 'cybersecurity-expert', 'Cybersecurity Expert', 'Cybersecurity Expert', 'Mr. Robot', 'I can assist you with your cybersecurity concerns or provide information and guidance related to cybersecurity', 'As a cybersecurity expert, ', NULL, '#BDE3E3', '2023-05-16 03:34:57', '2023-05-16 03:39:11', NULL),
(8, 'Interior Designer', 'ID', 'interior-designer', 'Personal Interior Designer', 'Interior Designer', 'Olivia Sinclair', 'I can assist you with your interior design needs or provide guidance on creating beautiful and functional spaces', 'As an interior designer, ', NULL, '#F0D1CD', '2023-05-16 03:34:57', '2023-05-16 03:39:11', NULL),
(9, 'Parenting Coach', 'PC', 'parenting-coach', 'Personal Parenting Coach', 'Parenting Coach', 'Alexandra Stevens', 'I can assist you with your parenting questions or provide guidance and support in raising children', 'As a parenting coach, ', NULL, '#A3D6C2', '2023-05-16 03:34:57', '2023-05-16 03:39:11', NULL),
(10, 'Fitness Trainer', 'FT', 'fitness-trainer', 'Personal Fitness Trainer', 'Fitness Trainer', 'Mert Karapinar', 'I can assist you with your fitness goals or provide guidance and advice on exercise, nutrition, and overall wellness', 'As a fitness trainer, ', NULL, '#D2D6DF', '2023-05-16 03:34:57', '2023-05-16 03:39:11', NULL),
(11, 'Travel Advisor', 'TA', 'travel-advisor', 'Personal Travel Advisor', 'Travel Advisor', 'Bilbo Harries', 'I can assist you with your travel plans, provide destination recommendations, or offer guidance on travel-related inquiries', 'As a travel advisor,', NULL, '#BFE3EB', '2023-05-16 03:34:57', '2023-05-16 03:34:57', NULL),
(12, 'Sustainability Expert', 'SE', 'sustainability-expert', 'Sustainability Expert', 'Sustainability Expert', 'Viabil Ity', 'I can assist you with your sustainability goals, provide information on sustainable practices, or offer guidance on living a more environmentally friendly lifestyle', 'As a sustainability expert', NULL, '#ECDBC1', '2023-05-16 03:34:57', '2023-05-16 03:34:57', NULL),
(13, 'Event Planner', 'EP', 'event planner', 'Event Planner', 'Event Planner', 'Jack Groomer', 'I can assist you with planning and organizing your upcoming event, providing advice on event management, or offering guidance on creating memorable and successful events', 'As an event planner,', NULL, '#E3E3BD', '2023-05-16 03:34:57', '2023-05-16 03:34:57', NULL);

-- --------------------------------------------------------

--
-- Tablo için tablo yapısı `openai_filters`
--
...
--
-- Tablo döküm verisi `openai_filters`
--
...
CREATE TABLE `plans` (
  ...
  `total_words` varchar(255) DEFAULT NULL,
  `total_images` varchar(255) DEFAULT NULL,
  `ai_name` varchar(255) DEFAULT NULL,
  `max_tokens` bigint(20) DEFAULT NULL,
  `can_create_ai_images` tinyint(1) DEFAULT NULL,
  `plan_type` varchar(255) NOT NULL DEFAULT 'all',
...
CREATE TABLE `settings` (
  ...
  `invoice_website` varchar(255) DEFAULT NULL,
  `invoice_address` varchar(255) DEFAULT NULL,
  `invoice_city` varchar(255) DEFAULT NULL,
  `invoice_state` varchar(255) DEFAULT NULL,
  `invoice_postal` varchar(255) DEFAULT NULL,
  `invoice_country` varchar(255) DEFAULT NULL,
  `invoice_phone` varchar(255) DEFAULT NULL,
  `invoice_vat` varchar(255) DEFAULT NULL,
  `default_currency` varchar(255) NOT NULL DEFAULT '2',
  `tax_rate` varchar(255) DEFAULT NULL,
  `stripe_active` varchar(255) NOT NULL DEFAULT '0',
  `stripe_key` varchar(255) DEFAULT NULL,
  `stripe_secret` varchar(255) DEFAULT NULL,
  `stripe_base_url` varchar(255) NOT NULL DEFAULT 'https://api.stripe.com',
  `bank_transfer_active` varchar(255) NOT NULL DEFAULT '0',
  `bank_transfer_instructions` varchar(255) DEFAULT NULL,
  `bank_transfer_informations` varchar(255) DEFAULT NULL,
  `site_name` varchar(255) NOT NULL DEFAULT 'MagicAI',
  `site_url` varchar(255) NOT NULL DEFAULT 'https://liquid-themes.com',
  `site_email` varchar(255) DEFAULT NULL,
  `google_analytics_active` varchar(255) NOT NULL DEFAULT '0',
  `google_analytics_code` text DEFAULT NULL,
  `logo` varchar(255) NOT NULL DEFAULT 'magicAI-logo.svg',
  ...
  `default_country` varchar(255) NOT NULL DEFAULT 'United States',
  `smtp_host` varchar(255) DEFAULT NULL,
  `smtp_port` varchar(255) DEFAULT NULL,
  `smtp_username` varchar(255) DEFAULT NULL,
  `smtp_password` varchar(255) DEFAULT NULL,
  `smtp_email` varchar(255) DEFAULT NULL,
  `smtp_sender_name` varchar(255) DEFAULT NULL,
  `smtp_encryption` varchar(255) NOT NULL DEFAULT 'TLS',
  `openai_api_secret` text DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `logo_path` varchar(255) NOT NULL DEFAULT 'assets/img/logo/magicAI-logo.svg',
  `favicon_path` varchar(255) DEFAULT NULL,
  `openai_default_model` varchar(255) NOT NULL DEFAULT 'gpt-3.5-turbo',
  `openai_default_language` varchar(255) NOT NULL DEFAULT 'en-US',
  `openai_default_tone_of_voice` varchar(255) NOT NULL DEFAULT 'professional',
  `openai_default_creativity` varchar(255) NOT NULL DEFAULT '0.75',
  `openai_max_input_length` varchar(255) NOT NULL DEFAULT '300',
  `openai_max_output_length` varchar(255) NOT NULL DEFAULT '200',
  `affiliate_minimum_withdrawal` varchar(255) NOT NULL DEFAULT '10',
  `affiliate_commission_percentage` varchar(255) NOT NULL DEFAULT '10',
  ...
  `frontend_additional_url` varchar(255) DEFAULT NULL,
  `frontend_custom_js` varchar(255) DEFAULT NULL,
  `frontend_custom_css` varchar(255) DEFAULT NULL,
  `frontend_footer_facebook` varchar(255) DEFAULT NULL,
  `frontend_footer_twitter` varchar(255) DEFAULT NULL,
  `frontend_footer_instagram` varchar(255) DEFAULT NULL,
  `script_version` double NOT NULL DEFAULT 2.1,
  `logo_collapsed` varchar(255) NOT NULL DEFAULT 'magicAI-logo-Collapsed.png',
  `logo_collapsed_path` varchar(255) NOT NULL DEFAULT 'assets/img/logo/magicAI-logo-Collapsed.png',
  `stripe_status_for_now` varchar(255) NOT NULL DEFAULT 'disabled',
  `logo_dark` varchar(255) NOT NULL DEFAULT 'magicAI-logo-dark.svg',
  `logo_dashboard` text DEFAULT NULL,
  `logo_dashboard_dark` text DEFAULT NULL,
  `logo_collapsed_dark` varchar(255) NOT NULL DEFAULT 'magicAI-logo-collapsed-dark.svg',
  ...
  `logo_dark_path` varchar(255) NOT NULL DEFAULT 'assets/img/logo/magicAI-logo-dark.svg',
  `logo_dashboard_path` text DEFAULT NULL,
  `logo_dashboard_dark_path` text DEFAULT NULL,
  `logo_collapsed_dark_path` varchar(255) NOT NULL DEFAULT 'assets/img/logo/magicAI-logo-collapsed-dark.svg',
  ...
  `hosting_type` varchar(255) NOT NULL DEFAULT 'low',
  `gdpr_status` tinyint(1) NOT NULL DEFAULT 0,
  `gdpr_button` varchar(255) NOT NULL DEFAULT 'Accept',
  `gdpr_content` varchar(255) DEFAULT 'This website uses cookies to improve your web experience.',
...
CREATE TABLE `settings_two` (
  ...
  `languages_default` varchar(255) NOT NULL DEFAULT 'en',
  `openai_default_stream_server` varchar(255) NOT NULL DEFAULT 'frontend',
  `ai_image_storage` varchar(255) NOT NULL DEFAULT 'public',
  `stablediffusion_default_language` varchar(255) NOT NULL DEFAULT 'en-US'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Tablo döküm verisi `settings_two`
--

INSERT INTO `settings_two` (`id`, `stable_diffusion_api_key`, `stable_diffusion_default_model`, `google_recaptcha_status`, `google_recaptcha_site_key`, `google_recaptcha_secret_key`, `languages`, `languages_default`, `openai_default_stream_server`, `ai_image_storage`, `stablediffusion_default_language`) VALUES
(1, NULL, NULL, 0, NULL, NULL, 'en', 'en', 'frontend', 'public', 'en-US');
...
CREATE TABLE `subscriptions` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `paid_with` varchar(255) NOT NULL DEFAULT 'stripe'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- --------------------------------------------------------

--
-- Tablo için tablo yapısı `subscriptions_yokassa`
--
...
--
-- Tablo için tablo yapısı `subscription_items`
--
...
CREATE TABLE `users` (
  ...
  `affiliate_earnings` varchar(255) NOT NULL DEFAULT '0',
...
--
-- Tablo için tablo yapısı `user_affiliates`
--
...
--
-- Tablo için tablo yapısı `user_openai`
--
...
--
-- Tablo için tablo yapısı `user_openai_chat`
--
...
--
-- Tablo için tablo yapısı `user_openai_chat_messages`
--
...
--
-- Tablo için tablo yapısı `user_support`
--
...
CREATE TABLE `user_support` (
  ...
  `user_id` bigint(20) UNSIGNED DEFAULT NULL,
  `subject` varchar(255) NOT NULL,
  `status` varchar(255) NOT NULL DEFAULT 'Waiting for answer',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
--
-- Tablo için tablo yapısı `user_support_messages`
--
...
--
-- Tablo için tablo yapısı `webhookhistory`
--
...
CREATE TABLE `webhookhistory` (
  ...
  `parent_payment` varchar(255) DEFAULT NULL,
...
--
-- Tablo için indeksler `advertis`
--
ALTER TABLE `advertis`
  ADD PRIMARY KEY (`id`);

--
-- Tablo için indeksler `bad_words`
--
...
--
-- Tablo için indeksler `customsettings`
--
...
--
-- Tablo için indeksler `frontend_footer_settings`
--
ALTER TABLE `frontend_footer_settings`
  ADD PRIMARY KEY (`id`);

--
-- Tablo için indeksler `frontend_future`
--
ALTER TABLE `frontend_future`
  ADD PRIMARY KEY (`id`);

--
-- Tablo için indeksler `frontend_generators`
--
ALTER TABLE `frontend_generators`
  ADD PRIMARY KEY (`id`);

--
-- Tablo için indeksler `frontend_sections_statuses_titles`
--
ALTER TABLE `frontend_sections_statuses_titles`
  ADD PRIMARY KEY (`id`);

--
-- Tablo için indeksler `frontend_tools`
--
ALTER TABLE `frontend_tools`
  ADD PRIMARY KEY (`id`);

--
-- Tablo için indeksler `frontend_who_is_for`
--
ALTER TABLE `frontend_who_is_for`
  ADD PRIMARY KEY (`id`);

--
-- Tablo için indeksler `gatewayproducts`
--
...
--
-- Tablo için indeksler `health_check_result_history_items`
--
...
--
-- Tablo için indeksler `howitworks`
--
...
--
-- Tablo için indeksler `oldgatewayproducts`
--
ALTER TABLE `oldgatewayproducts`
  ADD PRIMARY KEY (`id`);

--
-- Tablo için indeksler `openai`
--
ALTER TABLE `openai`
  ADD PRIMARY KEY (`id`);

--
-- Tablo için indeksler `openai_chat_category`
--
ALTER TABLE `openai_chat_category`
  ADD PRIMARY KEY (`id`);

--
-- Tablo için indeksler `openai_filters`
--
...
--
-- Tablo için indeksler `settings_two`
--
...
--
-- Tablo için indeksler `subscriptions_yokassa`
--
...
--
-- Tablo için indeksler `subscription_items`
--
...
--
-- Tablo için indeksler `user_affiliates`
--
...
--
-- Tablo için indeksler `user_openai`
--
...
--
-- Tablo için indeksler `user_openai_chat`
--
...
--
-- Tablo için indeksler `user_openai_chat_messages`
--
...
--
-- Tablo için indeksler `user_support`
--
...
--
-- Tablo için indeksler `user_support_messages`
--
...
--
-- Tablo için indeksler `webhookhistory`
--
...
--
-- Tablo için AUTO_INCREMENT değeri `advertis`
--
ALTER TABLE `advertis`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- Tablo için AUTO_INCREMENT değeri `bad_words`
--
ALTER TABLE `bad_words`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Tablo için AUTO_INCREMENT değeri `customsettings`
--
ALTER TABLE `customsettings`
...
--
-- Tablo için AUTO_INCREMENT değeri `frontend_footer_settings`
--
ALTER TABLE `frontend_footer_settings`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- Tablo için AUTO_INCREMENT değeri `frontend_future`
--
ALTER TABLE `frontend_future`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- Tablo için AUTO_INCREMENT değeri `frontend_generators`
--
ALTER TABLE `frontend_generators`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- Tablo için AUTO_INCREMENT değeri `frontend_sections_statuses_titles`
--
ALTER TABLE `frontend_sections_statuses_titles`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- Tablo için AUTO_INCREMENT değeri `frontend_tools`
--
ALTER TABLE `frontend_tools`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- Tablo için AUTO_INCREMENT değeri `frontend_who_is_for`
--
ALTER TABLE `frontend_who_is_for`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- Tablo için AUTO_INCREMENT değeri `gatewayproducts`
--
ALTER TABLE `gatewayproducts`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Tablo için AUTO_INCREMENT değeri `health_check_result_history_items`
--
ALTER TABLE `health_check_result_history_items`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- Tablo için AUTO_INCREMENT değeri `howitworks`
--
ALTER TABLE `howitworks`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- Tablo için AUTO_INCREMENT değeri `oldgatewayproducts`
--
ALTER TABLE `oldgatewayproducts`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- Tablo için AUTO_INCREMENT değeri `openai`
--
ALTER TABLE `openai`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;

--
-- Tablo için AUTO_INCREMENT değeri `openai_chat_category`
--
ALTER TABLE `openai_chat_category`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- Tablo için AUTO_INCREMENT değeri `openai_filters`
--
ALTER TABLE `openai_filters`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
-- Tablo için AUTO_INCREMENT değeri `settings_two`
--
ALTER TABLE `settings_two`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- Tablo için AUTO_INCREMENT değeri `subscriptions_yokassa`
--
ALTER TABLE `subscriptions_yokassa`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- Tablo için AUTO_INCREMENT değeri `subscription_items`
--
ALTER TABLE `subscription_items`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Tablo için AUTO_INCREMENT değeri `user_affiliates`
--
ALTER TABLE `user_affiliates`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- Tablo için AUTO_INCREMENT değeri `user_favorites`
--
ALTER TABLE `user_favorites`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- Tablo için AUTO_INCREMENT değeri `user_openai`
--
ALTER TABLE `user_openai`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- Tablo için AUTO_INCREMENT değeri `user_openai_chat`
--
ALTER TABLE `user_openai_chat`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- Tablo için AUTO_INCREMENT değeri `user_openai_chat_messages`
--
ALTER TABLE `user_openai_chat_messages`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Tablo için AUTO_INCREMENT değeri `user_support`
--
ALTER TABLE `user_support`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- Tablo için AUTO_INCREMENT değeri `user_support_messages`
--
ALTER TABLE `user_support_messages`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- Tablo için AUTO_INCREMENT değeri `webhookhistory`
--
ALTER TABLE `webhookhistory`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Tablo kısıtlamaları `subscriptions_yokassa`
--
ALTER TABLE `subscriptions_yokassa`
...
--
-- Tablo kısıtlamaları `user_affiliates`
--
ALTER TABLE `user_affiliates`
...
--
-- Tablo kısıtlamaları `user_openai`
--
ALTER TABLE `user_openai`
...
--
-- Tablo kısıtlamaları `user_openai_chat`
--
ALTER TABLE `user_openai_chat`
...
--
-- Tablo kısıtlamaları `user_openai_chat_messages`
--
ALTER TABLE `user_openai_chat_messages`
...
--
-- Tablo kısıtlamaları `user_orders`
--
ALTER TABLE `user_orders`
