...
--
-- Host: localhost    Database: magicai_app
-- ------------------------------------------------------
...
CREATE TABLE `clients` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `avatar` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'assets/img/auth/default-avatar.png',
...
CREATE TABLE `frontend_footer_settings` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `header_title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Limited Offer',
  `header_text` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Sign up and receive 20% bonus discount on checkout.',
  `hero_subtitle` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Unleash the Power of AI',
  `hero_title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Ultimate AI',
  `hero_description` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'All-in-one platform to generate AI content and start making money in minutes.',
  `hero_scroll_text` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Discover MagicAI',
  `hero_button` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Start Making Money',
  `hero_button_url` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `footer_header` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Start your free trial.',
  `footer_text_small` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Pay once, own forever.',
  `footer_text` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Unlock your business potential by letting the AI work and generate money for you.',
  `footer_button_text` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Join our community',
  `footer_button_url` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'https://codecanyon.net/item/magicai-openai-content-text-image-chat-code-generator-as-saas/45408109',
  `footer_copyright` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '2023 MagicAI. All images are for demo purposes.',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `hero_title_text_rotator` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT 'Generator,Chatbot,Assistant',
  `sign_in` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Sign In',
  `join_hub` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Join Hub',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `frontend_footer_settings` VALUES (1,'Limited Offer','Sign up and receive 20% bonus discount on checkout.','Unleash the Power of AI','Ultimate AI','All-in-one platform to generate AI content and start making money in minutes.','Discover MagicAI','Start Making Money',NULL,'Start your free trial.','Pay once, own forever.','Unlock your business potential by letting the AI work and generate money for you.','Join our community','https://codecanyon.net/item/magicai-openai-content-text-image-chat-code-generator-as-saas/45408109','2023 MagicAI. All images are for demo purposes.','2023-08-07 11:05:10','2023-08-07 11:05:10','Generator,Chatbot,Assistant','Sign In','Join Hub');
...
CREATE TABLE `frontend_generators` (
  ...
  `image_subtitle` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `frontend_sections_statuses_titles` (
  ...
  `features_title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'The future of AI.',
  ...
  `custom_templates_subtitle_one` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Custom',
  `custom_templates_subtitle_two` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Prompts',
  `custom_templates_title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Custom Templates.',
  `custom_templates_description` text COLLATE utf8mb4_unicode_ci,
  `tools_active` tinyint(1) NOT NULL DEFAULT '1',
  `tools_title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Magic Tools.',
  `tools_description` text COLLATE utf8mb4_unicode_ci,
  `how_it_works_active` tinyint(1) NOT NULL DEFAULT '1',
  `how_it_works_title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'So, how does it work?',
  `testimonials_active` tinyint(1) NOT NULL DEFAULT '1',
  `testimonials_title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Trusted by millions.',
  `testimonials_subtitle_one` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Testimonials',
  `testimonials_subtitle_two` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Trustpilot',
  `pricing_active` tinyint(1) NOT NULL DEFAULT '1',
  `pricing_title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Flexible Pricing.',
  `pricing_description` text COLLATE utf8mb4_unicode_ci,
  `pricing_save_percent` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Save 30%',
  `faq_active` tinyint(1) NOT NULL DEFAULT '1',
  `faq_title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Have a question?',
  `faq_subtitle` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Our support team will get assistance from AI-powered suggestions, making it quicker than ever to handle support requests.',
  `faq_text_one` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'FAQ',
  `faq_text_two` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Help Center',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `preheader_active` tinyint(1) NOT NULL DEFAULT '1',
  `blog_active` tinyint(1) NOT NULL DEFAULT '0',
  `blog_title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Latest News',
  `blog_subtitle` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Stay up-to-date',
  `blog_posts_per_page` int NOT NULL DEFAULT '3',
  `blog_button_text` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Show more',
  `blog_a_title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Blog Posts',
  `blog_a_subtitle` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Latest News',
  `blog_a_description` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Welcome to our cozy corner of the internet, where you will find a delightful collection of our heartfelt and thought-provoking blog posts.',
...
CREATE TABLE `gatewayproducts` (
  ...
  `gateway_code` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `gateways` (
  ...
  `sandbox_app_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `live_client_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `live_client_secret` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `live_app_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payment_action` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `currency` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `currency_locale` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `validate_ssl` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `oldgatewayproducts` (
  ...
  `gateway_code` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `product_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `old_price_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `new_price_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `openai_chat_category` (
  ...
  `human_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `helps_with` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `prompt_prefix` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `image` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `color` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
INSERT INTO `openai_chat_category` VALUES (1,'Default AI Chat Bot','ACB','ai-chat-bot','Default','default','','','','','#A3D6C2','2023-05-16 03:34:57','2023-05-16 03:39:11',NULL,0,0,'admin'),(2,'Finance Expert','FE','finance-expert','Personal Finance Expert','Finance Expert','Allison Burgers','I can help you with managing your finance','As a personal finance expert,',NULL,'#DBD5F5','2023-05-16 03:34:57','2023-05-16 03:39:11',NULL,0,0,'admin'),(3,'Nutritionist','N','nutritionist','Personal Nutritionist','Nutritionist','Employes Mustwashhands','I can assist you with nutrition-related information or questions','As a nutritionist,',NULL,'#EDBBBE','2023-05-16 03:34:57','2023-05-16 03:39:11',NULL,0,0,'admin'),(4,'Career Counselor','CC','career-counselor','Personal Career Counselor','Career Counselor','Neil Feetstrong','I can assist you with your career-related inquiries or concerns','As a career counselor,',NULL,'#D4D4E2','2023-05-16 03:34:57','2023-05-16 03:39:11',NULL,0,0,'admin'),(5,'Time Management Consultant','TMC','time-management-consultant','Personal Time Management Consultant','Time Management Consultant','Sarman Yellow','I can assist you with improving your time management skills or addressing any time management challenges you may be facing','As a time management consultant,',NULL,'#D6CBA3','2023-05-16 03:34:57','2023-05-16 03:39:11',NULL,0,0,'admin'),(6,'Language Tutor','LT','language-tutor','Personal Language Tutor','Language Tutor','Sherlock Jonas','I can assist you with your language learning goals or provide guidance on language-related topics','As a language tutor,',NULL,'#EACCEB','2023-05-16 03:34:57','2023-05-16 03:39:11',NULL,0,0,'admin'),(7,'Cybersecurity Expert','CE','cybersecurity-expert','Cybersecurity Expert','Cybersecurity Expert','Mr. Robot','I can assist you with your cybersecurity concerns or provide information and guidance related to cybersecurity','As a cybersecurity expert, ',NULL,'#BDE3E3','2023-05-16 03:34:57','2023-05-16 03:39:11',NULL,0,0,'admin'),(8,'Interior Designer','ID','interior-designer','Personal Interior Designer','Interior Designer','Olivia Sinclair','I can assist you with your interior design needs or provide guidance on creating beautiful and functional spaces','As an interior designer, ',NULL,'#F0D1CD','2023-05-16 03:34:57','2023-05-16 03:39:11',NULL,0,0,'admin'),(9,'Parenting Coach','PC','parenting-coach','Personal Parenting Coach','Parenting Coach','Alexandra Stevens','I can assist you with your parenting questions or provide guidance and support in raising children','As a parenting coach, ',NULL,'#A3D6C2','2023-05-16 03:34:57','2023-05-16 03:39:11',NULL,0,0,'admin'),(10,'Fitness Trainer','FT','fitness-trainer','Personal Fitness Trainer','Fitness Trainer','Mert Karapinar','I can assist you with your fitness goals or provide guidance and advice on exercise, nutrition, and overall wellness','As a fitness trainer, ',NULL,'#D2D6DF','2023-05-16 03:34:57','2023-05-16 03:39:11',NULL,0,0,'admin'),(11,'Travel Advisor','TA','travel-advisor','Personal Travel Advisor','Travel Advisor','Bilbo Harries','I can assist you with your travel plans, provide destination recommendations, or offer guidance on travel-related inquiries','As a travel advisor,',NULL,'#BFE3EB','2023-05-16 03:34:57','2023-05-16 03:34:57',NULL,0,0,'admin'),(12,'Sustainability Expert','SE','sustainability-expert','Sustainability Expert','Sustainability Expert','Viabil Ity','I can assist you with your sustainability goals, provide information on sustainable practices, or offer guidance on living a more environmentally friendly lifestyle','As a sustainability expert',NULL,'#ECDBC1','2023-05-16 03:34:57','2023-05-16 03:34:57',NULL,0,0,'admin'),(13,'Event Planner','EP','event planner','Event Planner','Event Planner','Jack Groomer','I can assist you with planning and organizing your upcoming event, providing advice on event management, or offering guidance on creating memorable and successful events','As an event planner,',NULL,'#E3E3BD','2023-05-16 03:34:57','2023-05-16 03:34:57',NULL,0,0,'admin');
...
INSERT INTO `openai_filters` VALUES (1,'blog'),(2,'ecommerce'),(3,'development'),(4,'advertisement'),(5,'Custom'),(6,'social media'),(7,'voiceover');
...
CREATE TABLE `plans` (
  ...
  `total_images` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ai_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `max_tokens` bigint DEFAULT NULL,
  `can_create_ai_images` tinyint(1) DEFAULT NULL,
  `plan_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'all',
...
CREATE TABLE `settings` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `invoice_currency` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `invoice_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `invoice_website` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `invoice_state` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `invoice_postal` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `invoice_country` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `invoice_phone` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `invoice_vat` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `default_currency` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '2',
  `tax_rate` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `stripe_active` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  ...
  `stripe_base_url` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'https://api.stripe.com',
  `bank_transfer_active` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `bank_transfer_instructions` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `bank_transfer_informations` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `site_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'MagicAI',
  `site_url` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'https://liquid-themes.com',
  `site_email` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `google_analytics_active` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `google_analytics_code` text COLLATE utf8mb4_unicode_ci,
  `logo` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'magicAI-logo.svg',
  ...
  `default_country` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'United States',
  ...
  `smtp_sender_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `logo_path` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'assets/img/logo/magicAI-logo.svg',
  `favicon_path` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `openai_default_model` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'gpt-3.5-turbo',
  `openai_default_language` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'en-US',
  `openai_default_tone_of_voice` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'professional',
  `openai_default_creativity` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0.75',
  `openai_max_input_length` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '300',
  `openai_max_output_length` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '200',
  `affiliate_minimum_withdrawal` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '10',
  `affiliate_commission_percentage` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '10',
  ...
  `frontend_additional_url` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `frontend_custom_js` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `frontend_custom_css` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `frontend_footer_facebook` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `frontend_footer_twitter` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `frontend_footer_instagram` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `script_version` double NOT NULL DEFAULT '2.1',
  `logo_collapsed` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'magicAI-logo-Collapsed.png',
  `logo_collapsed_path` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'assets/img/logo/magicAI-logo-Collapsed.png',
  `stripe_status_for_now` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'disabled',
  `logo_dark` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'magicAI-logo-dark.svg',
  `logo_dashboard` text COLLATE utf8mb4_unicode_ci,
  `logo_dashboard_dark` text COLLATE utf8mb4_unicode_ci,
  `logo_collapsed_dark` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'magicAI-logo-collapsed-dark.svg',
  ...
  `logo_dark_path` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'assets/img/logo/magicAI-logo-dark.svg',
  `logo_dashboard_path` text COLLATE utf8mb4_unicode_ci,
  `logo_dashboard_dark_path` text COLLATE utf8mb4_unicode_ci,
  `logo_collapsed_dark_path` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'assets/img/logo/magicAI-logo-collapsed-dark.svg',
  ...
  `hosting_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'low',
  `gdpr_status` tinyint(1) NOT NULL DEFAULT '0',
  `gdpr_button` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Accept',
  `gdpr_content` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT 'This website uses cookies to improve your web experience.',
...
INSERT INTO `settings` VALUES (1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2',NULL,'0',NULL,NULL,'https://api.stripe.com','0',NULL,NULL,'MagicAI','https://liquid-themes.com',NULL,'0',NULL,'magicAI-logo.svg',NULL,NULL,NULL,0,NULL,NULL,NULL,0,NULL,NULL,NULL,0,NULL,NULL,NULL,0,NULL,NULL,NULL,1,'United States',NULL,NULL,NULL,NULL,NULL,NULL,'TLS',NULL,'2023-08-07 11:05:10','2023-08-07 11:05:10','assets/img/logo/magicAI-logo.svg',NULL,'gpt-3.5-turbo','en-US','professional','0.75','300','200','10','10',1,1,1,NULL,NULL,NULL,NULL,NULL,NULL,2.1,'magicAI-logo-Collapsed.png','assets/img/logo/magicAI-logo-Collapsed.png','disabled','magicAI-logo-dark.svg',NULL,NULL,'magicAI-logo-collapsed-dark.svg',NULL,NULL,NULL,NULL,NULL,NULL,'assets/img/logo/magicAI-logo-dark.svg',NULL,NULL,'assets/img/logo/magicAI-logo-collapsed-dark.svg',NULL,NULL,NULL,NULL,NULL,NULL,1,1,1,1,1,1,NULL,NULL,NULL,NULL,NULL,'low',0,'Accept','This website uses cookies to improve your web experience.',NULL,0,0,NULL,NULL,1,1,NULL,NULL,NULL,NULL,NULL,NULL,'0,0');
...
CREATE TABLE `settings_two` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `stable_diffusion_api_key` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `stable_diffusion_default_model` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `languages` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT 'en',
  `languages_default` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'en',
  `openai_default_stream_server` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'frontend',
  `ai_image_storage` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'public',
  `stablediffusion_default_language` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'en-US',
...
INSERT INTO `settings_two` VALUES (1,NULL,NULL,0,NULL,NULL,'en','en','frontend','public','en-US',NULL,NULL);
...
CREATE TABLE `subscriptions` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `paid_with` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'stripe',
  PRIMARY KEY (`id`),
...
CREATE TABLE `user_openai_chat` (
  ...
  `title` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `total_credits` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `total_words` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `user_openai_chat` VALUES (1,1,2,'Finance Expert Chat','0','0','2023-08-29 18:11:35','2023-08-29 18:11:35'),(2,1,2,'Finance Expert Chat','0','0','2023-08-29 18:11:37','2023-08-29 18:11:37'),(3,1,1,'Default AI Chat Bot Chat','0','0','2023-08-29 18:12:58','2023-08-29 18:12:58');
...
INSERT INTO `user_openai_chat_messages` VALUES (1,1,1,NULL,'First Initiation','Hi! I am Allison Burgers, and I\'m Finance Expert. I can help you with managing your finance','','0','0','2023-08-29 18:11:35','2023-08-29 18:11:35'),(2,2,1,NULL,'First Initiation','Hi! I am Allison Burgers, and I\'m Finance Expert. I can help you with managing your finance','','0','0','2023-08-29 18:11:37','2023-08-29 18:11:37'),(3,3,1,NULL,'First Initiation','Hi! I am Default AI Chat Bot, and I\'m here to answer all your questions','','0','0','2023-08-29 18:12:58','2023-08-29 18:12:58');
...
CREATE TABLE `user_orders` (
  ...
  `status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Waiting',
  `country` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'United States of America',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `user_id` bigint unsigned DEFAULT NULL,
  `type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'subscription',
...
CREATE TABLE `user_support` (
  ...
  `user_id` bigint unsigned DEFAULT NULL,
  `subject` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Waiting for answer',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `user_support_messages` (
  ...
  `sender` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'user',
...
CREATE TABLE `users` (
  ...
  `affiliate_earnings` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
...
INSERT INTO `users` VALUES (1,'Admin','Admin','admin@admin.com','5555555555','admin','$2y$10$XptdAOeFTxl7Yx2KmyfEluWY9Im6wpMIHoJ9V5yB96DgQgTafzzs6','assets/img/auth/default-avatar.png',NULL,NULL,NULL,NULL,NULL,1,3000000,3000000,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2023-08-07 11:05:10','2023-08-07 11:05:10',NULL,NULL,NULL,NULL,'P60NPGHAAFGD','0',NULL,NULL,NULL,0,NULL,NULL,NULL);
...
CREATE TABLE `webhookhistory` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `gatewaycode` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `webhook_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Dump completed on 2023-08-30 21:59:12
